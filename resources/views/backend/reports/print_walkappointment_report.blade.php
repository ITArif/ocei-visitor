...
@section('title', 'Print Walk Appointment Reports')
@section('dashboard-title', 'Print Walk Appointment Reports')
@section('breadcrumb-title', 'Print Walk Appointment Reports Information')
